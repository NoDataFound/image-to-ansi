...
__credits__ = ["Cory Kennedy", "Micah Elliott", "Kevin Lange", "Takumi Sueda", "Torry Crass"]
__maintainer__ = "CoryKennedy"
__email__ = "cory@darkintel.io"
__license__   = "WTFPL http://sam.zoy.org/wtfpl/"
__version__   = "0.3 - Updated for Python3" 
...
"                                        ||----w |\n" \
"                                        ||     ||\n" \
"                        Yes I know I'm an ASCII cowsay")
    print(75 * "=")
    ...
    print("Output to File:\n" \
        "\tpython3 image-to-ansi.py <inputfile> > <outputfile>")
    print("\n")

    print(75 * "-")

    print("Source: https://github.com/nodatafound/image-to-ansi")
